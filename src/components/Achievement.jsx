    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0'>
            ...
            <div className='flex flex-col justify-center '>
                <h1 className='md:leading-[72px] text-3xl font-bold'>Our <span className='text-[#2b4a8b]'>Achievements</span></h1>
                <p className='text-lg text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, impedit.</p>
                ...
                <div className='grid grid-cols-2 py-16'>
                    <div className='py-6 flex'>
                        ...
                        <div className='px-3'>
                            ...
                            <p className='text-[#6D737A]'>Teacher</p>
                        </div>
                    ...
                    <div className='py-6 flex'>
                        ...
                        <div className='px-3'>
                            ...
                            <p className='text-[#6D737A]'>Customer</p>
                        </div>
